...
@RestController
public class CurrentRaceRestController {
    ...
    public CurrentRaceRestController(ClanService clanService, MemberService memberService, CurrentRiverRaceService currentRiverRaceService, RiverRaceLogService riverRaceLogService, BattleService battleService, ClanRankingHolder clanRankingHolder) {
